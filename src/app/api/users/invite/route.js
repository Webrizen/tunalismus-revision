...
export async function POST(req) {
  ...
  // you should send an email to the invited user with a link to set their
  // password. This requires an email service (e.g., SendGrid, Mailgun)
  // and the necessary credentials configured in the environment variables.
