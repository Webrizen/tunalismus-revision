                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white dark:bg-zinc-800 p-6 rounded-2xl border border-zinc-100 dark:border-zinc-700">
                    ...
                    <p className="text-zinc-700 dark:text-zinc-300">
                      From my home in Hyderabad, I've created Tunalismus with one simple belief: languages are bridges to other cultures and to parts of yourself you never knew existed.
                    </p>
                  </div>
